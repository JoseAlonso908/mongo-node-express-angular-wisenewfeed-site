angular.module('er.directives', [])
			...
			link: function ($scope, element, attr) {
				...
				var init = function (options) {
					...
					if ($scope.type == 'own') {
						...
						console.log('feedAttributes ', feedAttributes,$scope.user);
	...
	.directive('post', function ($rootScope, $window, $timeout, identityService, postService, commentService, reactionsService, followService, reportModal, $location) {
		return {
			restrict: 'E',
